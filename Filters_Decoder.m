...
for b = 0 : n-1 % for samples 
   ...
   for k = 1:length(C{1})
       ...
       if ((length(feq)==6)&&(feq(1) == 200)&& (feq(2) == 400) && (feq(3) == 800) && (feq(4) == 2000) &&(feq(5) == 2400) &&(feq(6) == 3974))
           string = string + "B";
           break;
       end
       if((length(feq)==6)&&(feq(1) == 200)&& (feq(2) == 400) && (feq(3) == 1000) && (feq(4) == 1200) &&(feq(5) == 2400) &&(feq(6) == 3974))
           string = string + "E";
           break;
       end
       if((length(feq)==7)&&(feq(1) == 200)&& (feq(2) == 400) && (feq(3) == 600) && (feq(4) == 1000) &&(feq(5) == 800) &&(feq(6) == 1200) &&(feq(7) == 1600))
        string = string + "D";
           break;
       end
       if((length(feq)==5)&&(feq(1) == 200)&& (feq(2) == 400) && (feq(3) == 1000) && (feq(4) == 800) &&(feq(5) == 1600))
         string = string + "S";
           break;
       end 
       if((length(feq)==6)&&(feq(1) == 200)&& (feq(2) == 600) && (feq(3) == 1200) && (feq(4) == 2000) &&(feq(5) == 1600) &&(feq(6) == 2400))
           string = string + "P";
           break;
       end
       if((length(feq)==8)&&(feq(1) == 200)&& (feq(2) == 400) && (feq(3) == 1000) && (feq(4) == 800) &&(feq(5) == 1200) &&(feq(6) == 2000) &&(feq(7) == 1600)&& (feq(8) == 3974))
        string = string + "A";
           break;
       end
       if((length(feq)==7)&&(feq(1) == 200)&& (feq(2) == 600) && (feq(3) == 1000) && (feq(4) == 1200) &&(feq(5) == 2000) &&(feq(6) == 1600) &&(feq(7) == 2400))
        string = string + "Z";
           break;
       end
       %-------------------------------------------------------------------
